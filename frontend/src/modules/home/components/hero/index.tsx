...
const Hero = () => {
  return (
    ...
    <svg className="background-navy" width="1759" height="1024" viewBox="0 0 1759 1024" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="text-white absolute inset-0 z-10 flex flex-col justify-center items-center text-center small:text-left small:justify-end small:items-start small:p-32">
      ...
      className="logo"
      />
      <h1 id="more-nums" className="text-2xl-semi mb-4 drop-shadow-md shadow-black">
